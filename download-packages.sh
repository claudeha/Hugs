...
cat packages/patches/process-001-make-most-func-works.patch|patch -p1 -d packages/process
...
cat packages/patches/base-002-fix-upstream-mistake.patch|patch -p1 -d packages/base
